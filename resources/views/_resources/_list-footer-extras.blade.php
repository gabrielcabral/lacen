    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-red color-palette">
                ...
                <h4 class="modal-title" id="modalConfirmModelDeleteLabel">Você tem certeza<i class="fa fa-question"></i>
                </h4>
            </div>
            <div class="modal-body">
                <p> Tem certeza de que deseja excluir este item<i class="fa fa-question"></i></p>
            </div>

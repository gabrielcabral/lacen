...
if($_pageSubtitle == 'List'){
    $_pageSubtitle =  'Listar';
}
?>
...
@section('content')
    ...
    <div class="box box-info">
            ...
            <div class="box-tools pull-right">
                <form class="form" role="form" method="GET" action="{{ $_listLink }}">
                    <div class="input-group input-group-sm margin-r-5 pull-left" style="width: 200px;">
                        <input type="text" name="search" class="form-control" value="{{ $search }}" placeholder="Pesquisar...">
        ...
        <div class="box-body no-padding">
            ...
            @else
                <p class="margin-l-5 lead text-green">Nenhum registro foi encontrado.</p>
            @endif
        </div>
        <!-- /.box-body -->
        @if (count($records) > 0)
